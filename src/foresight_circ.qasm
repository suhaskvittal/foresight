...
u3(0,-pi,-pi/2) q[38];
cx q[38],q[37];
u3(1.5454924,1.3467702,-1.7948224) q[37];
...
u3(2.3428827,-pi/2,pi/2) q[39];
u3(2.3428827,-pi/2,pi/2) q[40];
barrier q[24],q[34],q[23],q[22],q[33],q[40],q[29],q[39],q[32],q[20],q[38],q[31],q[30];
measure q[24] -> c[0];
measure q[34] -> c[1];
measure q[23] -> c[2];
measure q[22] -> c[3];
