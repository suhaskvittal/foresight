...
for circ_name in "hwb4_49.qasm" "wim_266.qasm" "f2_232.qasm" "misex1_241.qasm" "radd_250.qasm"\
    "cycle10_2_110.qasm" "square_root_7.qasm" "vqe_n8.qasm"\
    "sym9_148.qasm" "life_238.qasm"
do
